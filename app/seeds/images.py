...
def seed_images():
    ...
    image1 = Image(
        product_id=1,
        url="https://i.ebayimg.com/images/g/EUEAAOSwn1dfLLEB/s-l1600.jpg",
    )
    image2 = Image(
        product_id=1,
        url="https://i.ebayimg.com/images/g/5U8AAOSwCK1fLLEk/s-l1600.jpg",
    )
    image3 = Image(
        product_id=1,
        url="https://i.ebayimg.com/images/g/boAAAOSwHFRfLLE4/s-l1600.jpg",
    )
    image4 = Image(
        product_id=1,
        url="https://i.ebayimg.com/images/g/3IQAAOSwEV1fLLFa/s-l1600.jpg",
    )
    image5 = Image(
        product_id=2,
        url="https://i.ebayimg.com/images/g/Wt4AAOSwSTVh-Hmr/s-l1600.jpg",
    )
    image6 = Image(
        product_id=2,
        url="https://i.ebayimg.com/images/g/kn0AAOSw4~hh-Hmz/s-l1600.jpg",
    )
    image7 = Image(
        product_id=2,
        url="https://i.ebayimg.com/images/g/xsAAAOSwSCBh-Hm7/s-l1600.jpg",
    )
    image8 = Image(
        product_id=2,
        url="https://i.ebayimg.com/images/g/aCIAAOSw0cVh-HnC/s-l1600.jpg",
    )
    image9 = Image(
        product_id=3,
        url="https://i.ebayimg.com/images/g/aIMAAOSwMQhh-tKO/s-l1600.jpg",
    )
    image10 = Image(
        product_id=3,
        url="https://i.ebayimg.com/images/g/-dIAAOSwbaFh-tKR/s-l1600.jpg",
    )
    image11 = Image(
        product_id=3,
        url="https://i.ebayimg.com/images/g/fvAAAOSwET1h-tKS/s-l1600.jpg",
    )
    image12 = Image(
        product_id=3,
        url="https://i.ebayimg.com/images/g/UgwAAOSwkrVh-tKT/s-l1600.jpg",
    )
    image13 = Image(
        product_id=4,
        url="https://i.ebayimg.com/images/g/ZnUAAOSwiE1h-Hp8/s-l1600.jpg",
    )
    image14 = Image(
        product_id=4,
        url="https://i.ebayimg.com/images/g/uV8AAOSwpY5fj40A/s-l1600.jpg",
    )
    image15 = Image(
        product_id=4,
        url="https://i.ebayimg.com/images/g/yQcAAOSwH2Zfj40J/s-l1600.jpg",
    )
    image16 = Image(
        product_id=5,
        url="https://i.ebayimg.com/images/g/ef0AAOSwRwhiZGbL/s-l1600.jpg",
    )
    image17 = Image(
        product_id=5,
        url="https://i.ebayimg.com/images/g/A0kAAOSw2G9iZGar/s-l1600.jpg",
    )
    image18 = Image(
        product_id=5,
        url="https://i.ebayimg.com/images/g/~WYAAOSwlC9iZGa3/s-l1600.jpg",
    )
    image19 = Image(
        product_id=6,
        url="https://i.ebayimg.com/images/g/iwIAAOSwSgNiWYXo/s-l1600.jpg",
    )
    image20 = Image(
        product_id=6,
        url="https://i.ebayimg.com/images/g/toMAAOSwO8xiWYXw/s-l1600.jpg",
    )
    image21 = Image(
        product_id=6,
        url="https://i.ebayimg.com/images/g/lDcAAOSwzmViWYX2/s-l1600.jpg",
    )
    image22 = Image(
        product_id=7,
        url="https://i.ebayimg.com/images/g/vxQAAOSwSHFiV2b~/s-l1600.jpg",
    )
    image23 = Image(
        product_id=7,
        url="https://i.ebayimg.com/images/g/TEUAAOSwi25ibE3U/s-l1600.jpg",
    )
    image24 = Image(
        product_id=7,
        url="https://i.ebayimg.com/images/g/wvwAAOSwjt1ibGdn/s-l1600.jpg",
    )
    image25 = Image(
        product_id=7,
        url="https://i.ebayimg.com/images/g/WtsAAOSw3-xibGdp/s-l1600.jpg",
    )
    image26 = Image(
        product_id=8,
        url="https://i.ebayimg.com/images/g/5PQAAOSwJsZicW~c/s-l1600.jpg",
    )
    image27 = Image(
        product_id=8,
        url="https://i.ebayimg.com/images/g/2gQAAOSw9d5icW~5/s-l1600.jpg",
    )
    image28 = Image(
        product_id=9,
        url="https://i.ebayimg.com/images/g/6AkAAOSw0uZiBd~w/s-l1600.jpg",
    )
    image29 = Image(
        product_id=9,
        url="https://i.ebayimg.com/images/g/axsAAOSwfvNiBd~8/s-l1600.jpg",
    )
    image30 = Image(
        product_id=9,
        url="https://i.ebayimg.com/images/g/qLgAAOSwgzBiBeAL/s-l1600.jpg",
    )
    image31 = Image(
        product_id=9,
        url="https://i.ebayimg.com/images/g/leIAAOSwEyliBeAV/s-l1600.jpg",
    )
    image32 = Image(
        product_id=10,
